export default {
  ...
  'dialog.archive.snowDescription': 'Archive "{name}"? This removes only the HAPI session record and keeps Snow session data.',
  ...
  'dialog.delete.snowDescription': 'Delete "{name}"? This removes both the HAPI session and the linked Snow session permanently.',
